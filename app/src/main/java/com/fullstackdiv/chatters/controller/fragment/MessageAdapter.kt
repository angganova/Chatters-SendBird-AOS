...
class MessageAdapter(private val mContext: Context, var chatModels: MutableList<BaseMessage>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    var picasso = Picasso.with(mContext)
...
//            }
    ...
    fun addMessageList(msg:MutableList<BaseMessage>){
        chatModels.addAll(msg)
        notifyDataSetChanged()
    }

    fun addMessage(msg:BaseMessage){
        chatModels.add(msg)
